...
<main>
    ...
    <section class="hero">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-3 col-sm-2 12 m-auto">
                    <div class="heroText">
        ...
        <?php if (is_active_sidebar('front_page_banner_video')) : ?>
            <?php dynamic_sidebar('front_page_banner_video'); ?>
        <?php endif; ?>
    ...
    <section class="menu section-padding">
        <div class="container">
            <div class="row">
                ...
                <?php
                $food_post = new WP_Query('post_type=food_menu&posts_per_page=6');


                ?>

                <?php while ($food_post->have_posts()) : $food_post->the_post(); ?>
                    <div class="col-4">
                        <div class="menu-thumb">
                            <div class="menu-image-wrap">

                                <img class="img-fluid rounded news-image" src="<?php the_field('food_image'); ?>" alt="<?php echo get_the_title(); ?>" />
                            </div>

                            <div class="menu-info d-flex flex-wrap align-items-center">
                                <h4 class="mb-0"><?php the_title(); ?></h4>
                                <span class="price-tag bg-white shadow-lg ms-4"><small>$</small><?php echo get_post_meta($post->ID, 'food_price', true); ?></span>
                            ...
                            <div class="menu-info d-flex flex-wrap align-items-center">
                                <div class="d-flex flex-wrap align-items-center w-100 mt-2">
                                    <h6 class="reviews-text mb-0 me-3"><?php echo get_post_meta($post->ID, 'rating', true); ?></h6>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="BgImage" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/alex-haney-CAhjZmVk5H4-unsplash.jpg')">
    </section>
    ...
    <section class="news section-padding">
        <div class="container">
            <div class="row">
                ...
                // Defaults args fetch posts starting with the most recent 
